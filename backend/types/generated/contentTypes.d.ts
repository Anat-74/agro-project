...
export interface ApiAiAssistantAiAssistant extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aiPersonality: Schema.Attribute.JSON &
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    quickSuggestions: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    welcomeDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Component<'contacts.email', true>;
    ...
    legal: Schema.Attribute.Component<'legal.bank-details', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    phones: Schema.Attribute.Component<'contacts.phone', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    socials: Schema.Attribute.Component<'contacts.social', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroSlider: Schema.Attribute.DynamicZone<['sliders.hero-slider']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
