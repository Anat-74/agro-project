...
<template>
  ...
  >
    ...
    <span
    :class="['hamburger-menu__categories', { 'hamburger-menu__categories_is-open': isOpen }]"
    >{{ "Все категории" }}
  ...
  >
   ...
   <h1
     ...
     <div class="dialog-hamburger__items">
      ...
      <NuxtLink class="dialog-hamburger__logo"
      :to="`/${currentLocale}`">
      <NuxtImg
   ...
   <AnimateTitle />
         ...
         class="dialog-hamburger__accordion accordion">
         <li 
   ...
   >{{ prod.name }}
    ...
    >{{ formatPhone(item.phoneNumber) }}
      ...
      <div class="dialog-hamburger__socials"
    v-if="socials"
   >
   <a
