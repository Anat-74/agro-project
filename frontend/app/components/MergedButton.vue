...
interface Props {
  variant?: 'primary' | 'danger' | 'icon' | 'hamburger' | 'dialog-menu' | 'lang-switcher' | 'go-forward-back' | 'share' | 'switch-locale-cart' | 'add-to-cart' | 'small-add-to-cart' | 'remove-cart-item' | 'remove-quantity-prod' | 'add-quantity-prod' | 'large' | 'go-to-top' | 'pagination' | 'close'
