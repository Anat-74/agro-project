...
.hero-slider {
  ...
  &__slider {
    ...
    // Двойной класс (.hero-slider__slider.hero-slider__slider_catalog-open)
    // повышает специфичность (0,3,0): иначе width:100% из USlider (.slider)
    // с такой же специфичностью (0,2,0) в бандле идёт позже и перебивает
